...
input_folder = "../data/arixv/pdfs"
output_folder = "../results/on_pdfs/llama3_3_latest"
...
def main():
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".pdf"):
            ...
            model_name = "llama3.3:latest" #"phi4:latest" #"gemma2:27b"	#"mistral:latest"
            ...
            output_path = os.path.join(output_folder, f"result_from_{filename[:-4]}.txt")
